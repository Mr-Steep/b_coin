...
export function BNXTtoBNBamount({inputValue, priceInBnb, countTokensCurrent, fixedValue}) {
    ...
    return (
        <div
            ...
            <div
                ...
                >{inputValue > 0 ? +inputValue : 0} BNXT (${inputValue ? +countTokensCurrent /10 : 0}) </span>
                <span
                ...
                <span
                    className="bg-textColor text-primaryBgColor sm:text-sm text-lg font-medium leading-5">
                                                                            {(priceInBnb / 10).toFixed(fixedValue)} BNB
                                                						</span>
            </div>
        </div>
    )
