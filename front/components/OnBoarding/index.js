        ...
        <Layout>
            <div className="w-full relative overflow-hidden">
                ...
                >
                    ...
                    <p className="md:text-[50px] text-[60px] text-whiteColor md:leading-[54.4px] leading-[65.28px] font-bold md:mb-4 ml-[106px] mb-[115px] ">
                        How to buy bNXT
                    </p>
                </div>

                <div className="md:px-4 px-[111px] pt-[35px] bg-whiteColor">
                    ...
                    <div className="max-w-[1920px] mx-auto relative">
                        ...
                        <div className="flex flex-col w-full">
                            ...
                            <p className="content-start text-lg text-blackColor max-w-[608px] md:mb-[55px] mt-[50px] mb-[92px]">Worem ipsum dolor sit amet, consectetur
                                adipiscing elit. Etiam eu turpis molestie, dictum est a, mattis tellus. Sed dignissim, metus nec
                                fringilla. </p>

                            <div className="flex flex-col text-blackColor mb-[114px]">

                                <div className="flex md:flex-col justify-between items-center mb-[90px]">
                                    <div className="max-w-[480px] md:mr-0 mr-[150px] md:mb-10">
                                        <div className="flex">
                                            <div className="bg-blackColor w-[50px] h-[31px] mr-[26px]"></div>
                                            <div>
                                ...
                                <div className="flex md:flex-col justify-between items-center mb-[90px]">
                                    <div className="max-w-[480px] md:mr-0 mr-[104px] md:mb-10">
                                        <div className="flex">
                                            <div className="bg-blackColor w-[70px] h-[31px] mr-[26px]"></div>
                                            <div>
                            ...
                            <button className="group mx-auto grid grid-cols-2 gap-[13px] bg-blackColor items-center justify-between rounded-md max-w-[282px] max-h-[60px] w-full px-[17px] pt-[17px] pb-[20px] md:mb-[70px] mb-[135px]"
                                    onClick={() => router.push('/')}>
                                <span className="text-whiteColor text-lg">Let’s Start!</span>
