...
export function ClipboardPopup({tokenModal, setPopupVisible}) {
    ...
    return (
        <Modal tokenModal={tokenModal} setPopupVisible={setPopupVisible}>
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex justify-between items-center bg-textColor max-w-[328px] w-full h-[65px] rounded-md pr-[22px] pl-[27px] py-[22px] z-30">
