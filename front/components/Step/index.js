           ...
           {step === 1 &&
               ...
               <div className="flex justify-between
                   ...
                   <div
                       ...
                       <Link href=""
                             className="grid grid-cols-2 gap-[8px] bg-whiteColor text-blackColor items-center rounded-md min-w-[130px] h-[42px] px-[32.5px] py-2"
           ...
           {step === 3 &&
               ...
               <div className="flex justify-between absolute
                   ...
                   <div
                       ...
                       <Link href=""
                             className="flex gap-[8px] bg-whiteColor text-blackColor items-center rounded-md max-w-[154px] h-[42px] pl-5 pr-6 py-2"
                             onClick={closeModal}
                       >
